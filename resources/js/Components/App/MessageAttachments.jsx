        ...
        <>
            {attachments.length > 0 && (
                <div className="mt-2 flex flex-wrap justify-end gap-1">
                    ...
                    justify-center text-gray-100 bg-gray-700 rounded absolute right-0 top-0 cursor-pointer hover:
                    bg-gray-800"
                                >
                            ...
                            {isImage(attachment) && (
                                <img
                                    src={attachment.url}
                                    className="object-contain aspect-square max-w-full max-h-32"
                                />
                            )}
                            ...
                            {isVideo(attachment) && (
                                <div className="relative flex justify-center items-center">
                                    ...
                                    <video src={attachment.url} controls className="max-w-full max-h-32" />
