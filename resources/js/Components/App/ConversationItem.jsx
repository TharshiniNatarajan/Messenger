...
const ConversationItem = ({
    ...
    return (
        <Link
            ...
            preserveState
            className={
                "conversation-item flex items-center gap-2 p-2 text-gray-300 transaction-all cursor-pointer border-1-4 hover:bg-black/30" +
                classes +
        ...
        >
            ...
            >
                <div className="flex gap-1 justify-between items-center">
                    <h3 className="text-sm front-semibold overflow-hidden text-nowrap text-ellipsis">
                        {conversation.name}
                    </h3>
